...
export function BottomNav() {
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-white border-t shadow-[0_-4px_0_hsl(var(--border))] z-50 flex items-center justify-around px-2">
