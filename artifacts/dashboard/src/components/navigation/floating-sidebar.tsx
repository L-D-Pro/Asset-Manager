...
export function FloatingSidebar() {
 ...
 >
 <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary text-primary-foreground font-extrabold text-sm shrink-0">
 JO
 </div>
 {expanded && (
 ...
 to={item.href}
 className={cn(
 "flex items-center rounded-xl transition-colors mb-0.5",
