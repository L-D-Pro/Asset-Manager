...
function Hero() {
  ...
  return (
    <section className="min-h-screen gamify-gradient-primary flex flex-col items-center justify-center text-center px-4 relative overflow-hidden pt-20 pb-16">
      ...
      <div className="relative max-w-3xl mx-auto w-full">
        ...
        >
          <Link
            to="/register"
            className="inline-flex items-center gap-2 text-base font-bold font-display bg-white text-primary hover:bg-white/90 transition-all px-6 py-3 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-0.5"
          >
            Get Started Free
          </Link>
          <button
            onClick={scrollToHow}
            className="inline-flex items-center gap-2 text-base font-bold font-display text-white border-2 border-white/50 hover:bg-white/10 transition-colors px-6 py-3 rounded-2xl cursor-pointer"
          >
            See How It Works
          </button>
        </motion.div>
        ...
        <div className="card-chunky bg-background">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <span className="text-sm font-bold font-display">Level 12</span>
            ...
            <div className="h-3 bg-surface rounded-full overflow-hidden border border-border/50">
              <div className="h-full gamify-gradient-primary rounded-full" style={{ width: '82%' }} />
            </div>
          </div>
          <div className="grid grid-cols-3 gap-3 mt-4">
            {[
              ...
              <div key={label} className="bg-surface rounded-xl p-3 text-center">
                <div className="text-lg font-bold font-display text-primary">{val}</div>
