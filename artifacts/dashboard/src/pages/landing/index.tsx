...
function Hero() {
 ...
 <Link
 to="/register"
            className="inline-flex items-center gap-2 text-base font-bold font-display bg-white text-primary hover:bg-white/90 transition-all px-6 py-3 rounded-2xl hover:-translate-y-0.5"
 >
 Get Started Free
 </Link>
 <button
